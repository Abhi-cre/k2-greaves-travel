            ...
            <div className="row m-0">
                <div className="col col-lg-2">
                    <div className={`row navMob ${(location!="/")?'hideClass':''}`}>
                        <div className="col">
                            <span className="sidebar-toggle ms-2" onClick={()=>props.showHideLeftNav()}>
                                <i className="hamburger align-self-center"></i>
                            </span>

                        </div>
                        <div className="col text-end" onClick={()=>props.showRightSide('compose')}>
                        ...
                        <div className="col-md-12">
                            <nav className="navbar navbar-expand-lg p-0 moreMenu">
                                <div className="container-fluid">
                                    <button className="navbar-toggler navbar-sub-top" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                            <li className="nav-item">
                                                ...
                                                <NavLink to="/" className="nav-link"> Mails</NavLink>
                                            </li>
                                            {/* <li className="nav-item">
                                            ...
                                            <li className="nav-item">
                                                ...
                                                <NavLink to="/mobile-users" className="nav-link"> Mobile Users</NavLink>
                                            </li>
                                            {(ALLOWEDUSER.filter((item:any)=>item==localStorage.getItem(USER_EMAIL)).length>0)?<li className="nav-item">
