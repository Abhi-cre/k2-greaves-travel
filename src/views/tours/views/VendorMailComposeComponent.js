...
class VendorMailComposeComponent extends React.Component {
    ...
    submitMailCompose = async() => {
          ...
          if(error=="")
          {
            let ToRecipients=this.props.vendorList.filter((item)=>item.id==this.state.toEmail)[0].email;
           ...
           let emailExtraContent='<p style="color:#ffffff">___K2GTBT___'+ArrayHelper.getValue(this.props.toursData,'tourRecordId')+'___K2GTBT___'+ArrayHelper.getValue(this.props.toursData,'tourName')+'___K2GTBT___'+ArrayHelper.getValue(this.props.toursData,'id')+'___K2GTBT___'+VendorId+'___K2GTBT___</p>';
    ...
    render(){
        ...
        return( <React.Fragment>
            ...
            <div className={`border-box ${(this.props.selectedTab!='vendorMailCompose')?'hide':''}`}>
               <h2 className="pb-3">Vendor Mail Compose</h2>
               ...
               <div className="email-details1 card1">
                    ...
                    <div className="form-group bordered-left-4 bordered-themeprimary">
                                ...
                                <select  name="toEmail" value={this.state.toEmail} className="form-control" onChange={this.handleChange} tabIndex="1">
