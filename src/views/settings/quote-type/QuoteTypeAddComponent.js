...
class QuoteTypeAddComponent extends React.Component {
    constructor(props){
        super(props);
    ...
    submit = async(event: any) => {
      ...
      this.setState({loader:true})
        ...
        let response= await SettingApi.PostSettingList(formData,'/api/QuoteType/Add');
        if(ArrayHelper.getValue(response,'isSuccess')==true)
        {
          this.setState({loader:false,'name':'','message':"Quote Type has been added",'messageType':'success'})
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h3 className="modal-title" id="exampleModalLabel">Add Quote Type</h3>
...
export default  QuoteTypeAddComponent;
