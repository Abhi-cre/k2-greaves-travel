...
class TourTypeAddComponent extends React.Component {
    constructor(props){
        super(props);
    ...
    submit = async(event: any) => {
      ...
      this.setState({loader:true})
        ...
        let response= await SettingApi.PostSettingList(formData,'/api/TourType/Add');
        if(ArrayHelper.getValue(response,'isSuccess')==true)
        {
          this.setState({loader:false,'name':'','message':"Tour Type has been added",'messageType':'success'})
           this.props.getTourTypeList();
        }
        else
        {
    ...
    render(){
        return(
            <React.Fragment>
                ...
                <div className="modal fade" id="tourTypeAdd" data-bs-keyboard="false" data-bs-backdrop="static">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h3 className="modal-title" id="exampleModalLabel">Add Tour Type</h3>
...
export default  TourTypeAddComponent;
