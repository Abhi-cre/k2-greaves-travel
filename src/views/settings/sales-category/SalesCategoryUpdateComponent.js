...
declare var $;
class SalesCategoryUpdateComponent extends React.Component {
    constructor(props){
        super(props);
    ...
    submit = async(event: any) => {
      ...
      this.setState({loader:true})
        ...
        let response= await SettingApi.PostSettingList(formData,'/api/SalesCategory/Update');
        if(ArrayHelper.getValue(response,'isSuccess')==true)
        {
          this.setState({loader:false,'message':"Sales Category has been updated",'messageType':'success'})
           this.props.updatedSalesCategoryList(ArrayHelper.getValue(formData,'salesCategory'));
           setTimeout(()=>{
    ...
    componentWillReceiveProps()
    {
        setTimeout(() => {
            ...
            this.setState({ 
            "id": ArrayHelper.getValue(this.props.selectedSalesCategory,'id'),    
            "name": ArrayHelper.getValue(this.props.selectedSalesCategory,'name')
            });
            },100);
    }
    render(){
        return(
            <React.Fragment>
                ...
                <div className="modal fade" id="salesCategoryUpdate" data-bs-keyboard="false" data-bs-backdrop="static">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h3 className="modal-title" id="exampleModalLabel">Update Sales Category</h3>
...
export default  SalesCategoryUpdateComponent;
