...
class ActionTypeAddComponent extends React.Component {
    ...
    submit = async(event: any) => {
      ...
      this.setState({loader:true})
        ...
        let response= await SettingApi.PostSettingList(formData,'/api/ActionType/Add');
        if(ArrayHelper.getValue(response,'isSuccess')==true)
        {
          this.setState({loader:false,'name':'','message':"Action Type has been added",'messageType':'success'})
           this.props.getActionTypeList();
        }
        else
        {
    ...
    render(){
        return(
            <React.Fragment>
                ...
                <div className="modal fade" id="actionTypeAdd" data-bs-keyboard="false" data-bs-backdrop="static">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h3 className="modal-title" id="exampleModalLabel">Add Action Type</h3>
