...
class ActionTypeUpdateComponent extends React.Component {
    ...
    submit = async(event: any) => {
      ...
      this.setState({loader:true})
        ...
        let response= await SettingApi.PostSettingList(formData,'/api/ActionType/Update');
        if(ArrayHelper.getValue(response,'isSuccess')==true)
        {
          this.setState({loader:false,'message':"Action Type has been updated",'messageType':'success'})
           this.props.updatedActionTypeList(ArrayHelper.getValue(formData,'action'));
           setTimeout(()=>{
    ...
    componentWillReceiveProps()
    {
        setTimeout(() => {
            ...
            this.setState({ 
            "id": ArrayHelper.getValue(this.props.selectedActionType,'id'),    
            "name": ArrayHelper.getValue(this.props.selectedActionType,'name')
            });
            },100);
    }
    render(){
        return(
            <React.Fragment>
                ...
                <div className="modal fade" id="actionTypeUpdate" data-bs-keyboard="false" data-bs-backdrop="static">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h3 className="modal-title" id="exampleModalLabel">Update Action Type</h3>
