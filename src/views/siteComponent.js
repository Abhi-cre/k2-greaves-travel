...
import {
  ...
  USER_ID,
  DEPARTMENT_NAME,
  USER_LOCAL_STORAGE_LOGOUT_TIME,
  USER_EMAIL,
} from "../helpers/constants";
import SettingApi from "../api/Setting.api";
//import * as actionTypesUser from "../store/action/user.action";
const TopHeaderComponent = lazy(() =>
  import("../components/TopHeaderComponent")
);
const TopNevigationBarComponent = lazy(() =>
  import("../components/TopNevigationBarComponent")
);
...
const MobileUsersComponent = lazy(() =>
  import("./mobile-users/MobileUsersComponent.js")
);
const RecordComponent = lazy(() => import("./report/RecordComponent.js"));
      ...
      <React.Fragment>
        ...
        <div className="page-container">
          <TopNevigationBarComponent
            showRightSide={(str) => this.showRightSide(str)}
                ...
                <Routes>
                  <Route
                    ...
                    element={
                      <HomeSystemComponent
                        showRightSide={(str) => this.showRightSide(str)}
                        disPlayRight={this.state.disPlayRight}
