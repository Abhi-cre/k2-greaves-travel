            ...
            <React.Fragment>
                 ...
                 <form>
                    <div className="mb-4 form-floating">
                        <input type="text" className="form-control" id="floatingUser" placeholder="User Name"/>
                    ...
                    <div className="mb-4 form-floating">
                        ...
                        <span className="input-icon"><i className="fa-solid fa-eye"></i></span>
                    ...
                    <div className="mb-5 text-end text-white">
                      Existing User <strong><NavLink to="/user/login" className="text-theme-color">Login Here  </NavLink></strong>
                    </div>
                    <button type="submit" className="btn btn-primary w-100 btn-lg">Create Account</button>
                </form> 
            </React.Fragment>
        )
    }
