...
export const DISPLAYDATEFORMATE = "EEEE, dd MMMM yyyy"; // For Sandbox
export const VENDORTYPEIDBYDATE = "25";
export const ROUNTINGVENDOR = "27";
export const ALLOWEDUSER = [
  "asingh@web-fares.com",
  "pshrivastava@tl365.com",
  "icambata@tl365.com",
  "scambata@tl365.com",
  "vkapur@greavestours.com",
  "ssen@greavestours.com",
  "yratra@greavestours.com",
  "pjoshi@web-fares.com",
  "smehra@greavestours.com",
  "rthakur@web-fares.com",
  "kwattal@greavestours.com",
  "achauhan@greavestours.com",
  "Smehra@greavestours.com",
  "dsharma@greavestours.com",
  "akishor@web-fares.com",
];
export const DATEDURATION = (stateDate = "", EndDate = "") => {
  if (
    stateDate != "" &&
    EndDate != "" &&
    stateDate != "1900-01-01T00:00:00" &&
...
export function parseCityDetails(city: string) {
  if (city != "" && city != null && city != undefined) {
    ...
    return {
      ...
      stateCode: city.substr(
        city.indexOf(", ") + 2,
        city.indexOf(" -") - city.indexOf(", ") - 2
      ),
    };
  } else {
    return { cityName: "", cityCode: "", countryCode: "", stateCode: "" };
  }
}
...
export const config = {
  ...
  scropes: ["user read"],
  authority:
    "https://login.microsoftonline.com/796d2b31-0a6a-4258-9332-0ba263117204",
};
